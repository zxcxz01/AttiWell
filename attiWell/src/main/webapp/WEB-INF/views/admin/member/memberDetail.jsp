					...
					<tbody>
						<tr>
							...
							<td><input type="button" class="btn btn-secondary"
								value="수정하기" disabled
								onClick="fn_modify_member_info('${member_info.member_id }','member_id')" />
							</td>
						</tr>
						<tr>
						...
						<tr class="dot_line">
							...
							<td><input type="button" class="btn btn-secondary"
								value="수정하기" disabled
								onClick="fn_modify_member_info('${member_info.member_name}','member_name')" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><select name="tel1">
								...
								value="${member_info.tel2 }"> - <input type="text"
								size=4 name="tel3" value="${member_info.tel3 }"></td>
							<td><input type="button" class="btn btn-secondary"
								value="수정하기"
						...
						<tr>
							...
							<td><select name="hp1">
								...
								name="hp3" size=4 value="${member_info.hp3 }"><br>
								<br> <c:choose>
							...
							<td><input type="text" id="zipcode" name="zipcode" size=5
								...
								<p>
									...
									<input type="text" id="roadAddress" name="roadAddress"
										size="50" value="${member_info.roadAddress }"><br>
						...
						<td><input type="hidden" name="command"
							value="modify_my_info" /> <c:choose>
								<c:when test="${member_info.del_yn=='Y' }">
									<input type="button" class="btn btn-secondary" value="회원복원"
